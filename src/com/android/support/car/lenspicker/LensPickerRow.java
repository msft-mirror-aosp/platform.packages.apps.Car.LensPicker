 ...
 */
public class LensPickerRow extends RecyclerView.ViewHolder {
    private final ImageView iconView;
    private final TextView titleView;

    public LensPickerRow(View itemView) {
        super(itemView);
        iconView = (ImageView) itemView.findViewById(R.id.icon);
        titleView = (TextView) itemView.findViewById(R.id.text);
    }

    public void bind(Context context, final LensPickerItem item,
                     final LensPickerSelectionHandler selectionHandler) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                selectionHandler.onActivitySelected(item);
            }
        });
    }
